...
All analysis must use ONLY these authenticated endpoints:

1. **NewsAPI.ai** - Real crypto news with authentic images and sentiment
2. **Coinalyze API** - Live derivatives data and liquidations
3. **BingX Public API** - Real-time spot market data and candlesticks
4. **CryptoNews API** - Historical and breaking news with urgency scoring
5. **CoinMarketCap Pro** - Authoritative market rankings and trending data
6. **DexScreener API** - Live DEX data and viral token discovery
7. **Railway Trading Platform** - Current positions and live P&L data
8. **De.Fi Security API** - Real exploit alerts and security analysis
9. **LunarCrush API** - Authentic social metrics and Galaxy Scores
