...
class HourlyTradeScanner:
    ...
    async def _get_top_200_coins(self):
        ...
        try:
            async with aiohttp.ClientSession() as session:
                ...
                url = f"{RAILWAY_API_URL}/api/market/top-performers"
                params = {
                    'limit': 200,
                    'timeframe': '24h',
    ...
    async def _get_technical_analysis(self, session, symbol):
        ...
        try:
            ...
            url = f"{RAILWAY_API_URL}/api/taapi/bulk"
            payload = {
                'symbol': symbol,
    ...
    async def _get_sentiment_analysis(self, session, symbol):
        ...
        try:
            url = f"{RAILWAY_API_URL}/api/sentiment/analyze/{symbol}"
    ...
    async def _get_social_analysis(self, session, symbol):
        ...
        try:
            url = f"{RAILWAY_API_URL}/api/social/momentum/{symbol}"
