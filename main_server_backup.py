...
try:
    from taapi_universal_indicators import taapi_universal
    ...
    try:
        ...
        for symbol in symbols:
            ...
            try:
                ...
                rsi_data = taapi_universal_indicators.get_indicator(
                    indicator='rsi',
                    symbol=symbol + '/USDT',
                    exchange='binance',
                    interval=timeframe
...
def macd_market_scan():
    ...
    try:
        ...
        for symbol in symbols[:limit * 2]:  # Check more to find matches
            try:
                macd_data = taapi_universal_indicators.get_indicator(
                    indicator='macd',
